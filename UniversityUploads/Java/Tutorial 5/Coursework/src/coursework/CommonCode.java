...
public class CommonCode {
    ...
    CommonCode(ActionListener call) {calledBy = call;
    initialiseVariables();
    }
    CommonCode() {
        initialiseVariables();
...
// This is used by CommonCode to set up the public variables.
    ...
    protected JMenuItem makeMenuItem(String txt,String actionCommand,
            String toolTipText,
            Font fnt){
...
/**
        ...
        * existing text.
        * @param fn
        * @param aContents* @throws java.io.FileNotFoundException
        */
